...
export const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "Подойдёт любой современный компьютер (Windows, Mac или Linux) с браузером и доступом в интернет. Для Onlook рекомендуем минимум 8 ГБ RAM.",
  },
  {
    question: "Нужен ли VPN?",
    answer:
      "Да, нужен. Многие сервисы работают только с ним.",
  },
  {
    question: "Входят ли подписки в стоимость?",
    answer:
      "Да! Подписка на Onlook ($15/мес) включена в стоимость курса на весь период обучения + 2 недели после завершения.",
  },
  {
