      ...
      >
        {audience.length > 0 ? (
          audience.map((item) => (
            ...
            <h3
              className="text-lead font-bold text-white mb-3 group-hover:text-red-primary transition-colors"
            >
              {item.title}
            </h3>
            ...
            <div
              className="absolute inset-0 bg-gradient-to-br from-red-primary/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity rounded-3xl pointer-events-none"
            />
          </Card>
          ))
        ) : (
