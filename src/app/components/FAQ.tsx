...
export default function FAQ() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Header */}
        <div className="text-center mb-12 sm:mb-16" data-oid="-evo62-">
          <h2
            className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4"
            data-oid="c8ad-7h"
          >
            Частые{" "}
            <span className="text-[#E50914]" data-oid="v000anq">
              вопросы
            </span>
          </h2>
          <p className="text-lg sm:text-xl text-gray-400" data-oid="6_8e4bh">
            Не нашли ответ?{" "}
            <a
        ...
        {/* FAQ Accordion */}
        <div className="space-y-4" data-oid="rre1m9f">
          {faqs.map((faq, index) => (
            <div
              key={index}
        ...
        {/* CTA */}
        <div className="mt-12 sm:mt-16 text-center" data-oid="g5d5_4q">
          <div
